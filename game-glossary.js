...
(function () {
  ...
  var TERMS = [
    ...
    { id: 'twelfth', label: 'Twelfth', syn: ['twelfths', 'twelfth'], def: 'A twelfth is one of TWELVE equal pieces. On a twelve-slice pizza, each single slice is a twelfth. Across two twelve-slice pizzas (24 slices), a twelfth is two slices.', math: 'on a 12-slice pizza, 1 of 12 = one twelfth = 1/12; over two of them, 2 of 24', demo: function () { return miniPizza(fillSet([0], ACCENT, DIM, 12), 12); } },
    { id: 'angle', label: 'Angle (degrees)', syn: ['wedge', 'degrees', 'degree', 'right angle', 'straight angle', '45°', '90°', '135°', '180°', '270°', '30°', '60°', '120°', '150°'], def: 'An angle measures how wide a wedge of pizza opens, in degrees (°). All the way round is 360°. A RIGHT ANGLE is 90° (a square corner, a quarter turn); a STRAIGHT ANGLE is 180° (half the pizza). On an eight-slice pizza each slice is 45°, so a 90° wedge is two slices; on a twelve-slice pizza each slice is 30°, so 90° is three slices.', math: 'whole turn 360°; right angle 90° (a quarter); straight 180° (a half); one slice = 360/slices (45° on 8, 30° on 12)', demo: function () { return miniPizza(fillSet([0, 1], ACCENT, DIM, 8), 8); } },
    { id: 'percent', label: 'Percent (%)', syn: ['percent', 'per cent', '100%', '80%', '75%', '70%', '60%', '50%', '40%', '30%', '25%', '20%', '10%'], def: 'Percent means "out of 100". The whole pizza is 100%, a half is 50%, a quarter is 25%, three quarters is 75%. On a ten-slice pizza each slice is 10%, so 30% is three slices.', math: 'whole = 100%, half = 50%, quarter = 25%; on a 10-slice pizza 10% = 1 slice (here 3 of 10 = 30%)', demo: function () { return miniPizza(fillSet([0, 1, 2], ACCENT, DIM, 10), 10); } },
    { id: 'decimal', label: 'Decimal (0.5)', syn: ['decimal', '0.1', '0.2', '0.25', '0.3', '0.4', '0.5', '0.6', '0.7', '0.75', '0.8', '0.9', '1.0'], def: 'A decimal writes a part with a dot. 0.5 is a half, 0.25 a quarter, 0.75 three quarters, 1.0 the whole. On a ten-slice pizza each slice is 0.1, so 0.3 is three slices; on an eight-slice pizza 0.25 is two slices.', math: 'whole = 1.0; half = 0.5 = 50%; quarter = 0.25 = 25%; on a 10-slice pizza 0.1 = 1 slice (here 0.3 = 3 of 10)', demo: function () { return miniPizza(fillSet([0, 1, 2], ACCENT, DIM, 10), 10); } },
  ...
  var CONCEPTS = {
    ...
    percent: 'This order was about PERCENT: how much out of 100. The whole pizza is 100%, a half is 50%, and a quarter is 25%.',
    decimal: 'This order was about DECIMALS: a part written with a dot. 0.5 is a half, 0.25 a quarter; on a ten-slice pizza each slice is 0.1.',
    angle: 'This order was about ANGLES: how wide a wedge opens, in degrees. A right angle is 90°, a straight angle 180°; all the way round is 360°.',
